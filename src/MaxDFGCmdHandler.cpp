...
{
	QHoldActions hold(_M("DFG Remove Nodes"));
...
{
	QHoldActions hold(_M("DFG Connect"));
...
{
	QHoldActions hold(_M("DFG Disconnect"));
...
{
	QHoldActions hold(_M("DFG Add Graph"));
...
{
	QHoldActions hold(_M("DFG Add Function"));
...
{
	QHoldActions hold(_M("DFG Load Preset"));
...
{
	QHoldActions hold(_M("DFG Add Var"));
...
{
	QHoldActions hold(_M("DFG Add Get"));
...
{
	QHoldActions hold(_M("DFG Add Set"));
...
{
	QHoldActions hold(_M("DFG Add Port"));
	...
	{
		m_pTranslationLayer->SetMaxConnectedType(res.c_str(), -2);
	}
	return res;
}
...
{
	QHoldActions hold(_M("DFG Edit Port"));
...
{
	QHoldActions hold(_M("DFG Remove Port"));
...
{
	QHoldActions hold(_M("DFG Resize Back Drop"));
...
{
	QHoldActions hold(_M("DFG Move Nodes"));
...
{
	QHoldActions hold(_M("DFG Implode Nodes"));
...
{
	QHoldActions hold(_M("DFG Explode Nodes"));
...
{
	QHoldActions hold(_M("DFG Add BackDrop"));
...
{
	QHoldActions hold(_M("DFG Set Node Title"));
...
{
	QHoldActions hold(_M("DFG Set Node Comment"));
...
{
	QHoldActions hold(_M("DFG Set Code"));
...
{
	QHoldActions hold(_M("DFG Rename Port"));
...
{
	QHoldActions hold(_M("DFG Paste"));
...
{
	QHoldActions hold(_M("DFG Set Arg Type"));
...
{
	QHoldActions hold(_M("DFG Set Arg Value"));
...
{
	QHoldActions hold(_M("DFG Set Def Value"));
...
{
	QHoldActions hold(_M("DFG Set Ref Path"));
...
{
	QHoldActions hold(_M("DFG Re-order Ports"));
...
{
	QHoldActions hold(_M("DFG Set External Dependencies"));
...
{
	QHoldActions hold(_M("DFG Split From Preset"));
