...
void MaxValueToSplice(FabricCore::Client& client, DFGWrapper::ExecPortPtr& port, TimeValue t, Interval& ivValid, const TResultType& param) { MaxValuesToSplice<TResultType, TResultType>(client, port, t, ivValid, &param, 1); }
