...
public:
	...
	BEGIN_FUNCTION_MAP	
		...
		VFN_3(fn_dfgDisconnect,							DFGDisconnect,			TYPE_TSTR_TAB_BR, TYPE_TSTR_TAB_BR, TYPE_TSTR );
		...
		FN_7(fn_dfgEditPort,		TYPE_TSTR_BV,		DFGEditPort,			TYPE_TSTR,		TYPE_TSTR, TYPE_ENUM, TYPE_TSTR, TYPE_TSTR, TYPE_TSTR, TYPE_TSTR);
	...
	MSTR DFGEditPort(const MSTR& portName, const MSTR& desiredNewPortName, int portType, const MSTR& typeSpec, const MSTR& extDep, const MSTR& metaData, const MSTR& execPath);
