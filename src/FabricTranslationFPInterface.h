...
public:
	...
	BEGIN_FUNCTION_MAP	
		...
		// r3d VFN_2(fn_dfgSetTitle,						DFGSetTitle,		TYPE_TSTR,		TYPE_TSTR);
		...
		// r3d VFN_2(fn_dfgSetArgType,							DFGSetArgType,			TYPE_TSTR,		TYPE_TSTR);
	...
	//r3d void DFGSetTitle(const MSTR& newTitle, const MSTR& execPath);
	...
	//r3d void DFGSetArgType(const MSTR& argName, const MSTR& argType);
