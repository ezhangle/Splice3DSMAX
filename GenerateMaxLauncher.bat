...
@echo.>> %LAUNCHER%
@echo if NOT EXIST Generated.Plugin.Fabric.ini (>> %LAUNCHER%
...
@echo 	@echo [Directories] ^>^> Generated.Plugin.Fabric.ini>> %LAUNCHER%
@echo 	@echo Additional MAX plug-ins=%%ADSK_3DSMAX_x64_%MAXVERSION%%%\PlugIns\ ^>^> Generated.Plugin.Fabric.ini>> %LAUNCHER%
@echo 	@echo Fabric Plugins=%%~dp0plugin\ ^>^> Generated.Plugin.Fabric.ini>> %LAUNCHER%
@echo 	@echo [Help] ^>^> Generated.Plugin.Fabric.ini>> %LAUNCHER%
